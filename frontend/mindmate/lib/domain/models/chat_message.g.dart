...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByEmbeddingId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'embeddingId', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByEmbeddingIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortBySentimentScore() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByEmbeddingId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'embeddingId', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByEmbeddingIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'embeddingId', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenBySentimentScore() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sentimentScore', Sort.asc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByEmbeddingId() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, int?, QQueryOperations> embeddingIdProperty() {
    return QueryBuilder.apply(this, (query) {
